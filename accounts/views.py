...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message = render_to_string('auth/auth_varification_email.html', {
                'user':user,
                'domain': current_site,
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    ##  - Getting the cart items from the user to access his products variations.
